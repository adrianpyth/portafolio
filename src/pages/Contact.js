...
export default function Contact() {
    ...
    return (
        ...
        >
            ...
            <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto w-full font-tourney font-bold">
                {/* FORMULARIO */}
                {!sent ? (
                    <form
                        ...
                        className="bg-gray-900/80 border-4 border-cyan-400 p-10 rounded-lg shadow-lg shadow-cyan-500/40 space-y-6"
                    >
                        {/* Nombre */}
                        <div>
                            <label className="block text-xs text-cyan-400 mb-2">NAME</label>
                            <input
                                type="text"
                                name="name"
                                required
                                placeholder="Your Name"
                                className="w-full p-3 bg-black border-2 border-cyan-500 text-green-400 text-sm placeholder-gray-500 focus:outline-none focus:border-pink-400"
                            />
                        </div>

                        {/* Asunto */}
                        <div>
                            <label className="block text-xs text-cyan-400 mb-2">SUBJECT</label>
                            <input
                                type="text"
                                name="subject"
                                required
                        ...
                        {/* Mensaje largo */}
                        <div>
                            <label className="block text-xs text-cyan-400 mb-2">MESSAGE</label>
                            <textarea
                                name="message"
                                required
                                placeholder="Write your message here..."
                                rows="4"
                                className="w-full p-3 bg-black border-2 border-cyan-500 text-green-400 text-sm placeholder-gray-500 resize-none focus:outline-none focus:border-pink-400"
                            />
                        </div>

                        {/* Contacto */}
                        <div>
                            <label className="block text-xs text-cyan-400 mb-2">CONTACT</label>
                            <input
                                type="email"
                                name="contact"
                                required
                ...
                {/* INFO PERSONAL */}
                <div className="flex flex-col justify-center items-center text-center bg-gray-900/80 border-4 border-pink-400 p-10 rounded-lg shadow-lg shadow-pink-500/40 text-2xl space-y-6">
                    <h2 className="text-pink-400 text-lg mb-4 animate-pulse">[ INFO DIRECTA ]</h2>
                    ...
                    <p className="text-gray-300">
                        <span className="text-cyan-400">Linkedink:</span>{" "}
                        <a
