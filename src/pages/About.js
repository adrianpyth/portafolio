...
export default function About() {
    return (
        <div
            id="about"
            className="relative min-h-screen flex flex-col justify-between space-y-6 p-6"
        ...
        >
           ...
           Se mantiene 'text-gray-300' y 'font-pixel' como base. */}
                        <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed font-pixel">
                            ...
                            <span className="text-orange-400">Java</span>. Skilled in{" "}
                            <span className="text-cyan-400">object-oriented programming</span>,{" "}
                            <span className="text-emerald-400">layered architecture</span>, and{" "}
                            <span className="text-yellow-400">SQL</span> database management.
                            Actively enhancing technical skills through{" "}
                            <span className="text-red-400">Oracle Next Education</span> in{" "}
            ...
            {/* GRID DE CARDS */}
            <div className="grid md:grid-cols-3 gap-6 mt-6 text-lg ">
                {/* Card 1 */}
                <div className="bg-gray-900/80 border-4 border-cyan-400 p-4 rounded-lg shadow-lg shadow-cyan-500/40">
                    <h2 className="text-cyan-400 text-lg mb-4 font-tourney animate-pulse text-center">[ FRONTEND ]</h2>

                    <div className="flex flex-col items-center space-y-6 text-gray-300">

                        {/* Fila 1: HTML + CSS */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-amber-600">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#E34F26]">
                                    <title>HTML5</title>
                                    <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 
                                            10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248
                                            l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/>
                                </svg>
                                <div className="text-xs font-thin font-pixel"> HTML5 </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-violet-600">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#663399]">
                                    <title>CSS</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> CSS3 </div>
                            </div>
                        </div>

                        {/* Fila 2: React + Tailwind */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-cyan-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#61DAFB]">
                                    <title>React</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> React </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-sky-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#06B6D4]">
                                    <title>Tailwind CSS</title>
                                    <path d="M12.001,4.8c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 C13.666,10.618,15.027,12,18.001,12c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C16.337,6.182,14.976,4.8,12.001,4.8z M6.001,12c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 c1.177,1.194,2.538,2.576,5.512,2.576c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C10.337,13.382,8.976,12,6.001,12z" />

                                </svg>
                                <div className="text-xs font-thin font-pixel"> Tailwind </div>

                            </div>

                        </div>

                        {/* Fila 3: TypeScript + JavaScript */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-blue-500">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#3178C6]">
                                ...
                                <div className="text-xs font-thin font-pixel"> TypeScript </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-yellow-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#F7DF1E]">
                                ...
                                <div className="text-xs font-thin font-pixel"> JavaScript </div>
                ...
                {/* Card 2 */}
                <div className="bg-gray-900/80 border-4 border-pink-400 p-4 rounded-lg shadow-lg shadow-pink-500/40">
                    <h2 className="text-pink-400 text-lg mb-4 font-tourney animate-pulse text-center">[ BACKEND ]</h2>
                    <div className="flex flex-col items-center space-y-6 text-gray-300">

                        {/* Fila 1: Spring + Java */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-600">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#6DB33F]">
                                ...
                                <div className="text-xs font-thin font-pixel"> Spring Boot </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-red-600">
                                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" alt="Java" className="w-16 h-16" />
                                <div className="text-xs font-thin font-pixel"> Java </div>
                            </div>

                        </div>

                        {/* Fila 2: Python + Spring */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-sky-500">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-yellow-400">
                                    <title>Python</title>
                               ...
                               "></path> </svg>
                                <div className="text-xs font-thin font-pixel"> Python </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#6DB33F]">
                                    <title>SPRING</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> Spring </div>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-6">
                            ...
                            <div className="w-20 h-20 flex  items-center justify-center rounded-lg shadow-sm shadow-purple-500">
                                <div className="text-6xl font-bold" >C</div>
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-purple-900">
                                    <title>C#</title>
                            ...
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-amber-700">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#C71A36]">
                                    <title>Maven</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> Maven</div>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-6">
                            ...
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-amber-50">

                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#CB3837]">
                                    <title>npm</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> npm </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-300">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#83CD29]">
                                    <title>node,js</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> Node.js</div>
                            </div>
                        </div>

                        {/* Fila 5: djgano + loading */}
                        <div className="flex space-x-6">

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-500">

                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#093E29]">
                                    <title>DJGANGO</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> Django </div>
                            </div>

                            {/*                             <div className="w-20 h-20 flex items-center justify-center rounded-lg shadow-sm shadow-yellow-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-yellow-400">
                                    <title>node,js</title>
                ...
                {/* Card 3 */}
                <div className="bg-gray-900/80 border-4 border-green-400 p-4 rounded-lg shadow-lg shadow-green-500/40">
                    <h2 className="text-green-400 text-lg mb-4 font-tourney animate-pulse text-center">[ DATABASE & CLOUD ]</h2>
                    <div className="flex flex-col items-center space-y-6 text-gray-300">

                        {/* Fila 1: Spring + Java */}
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-600">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#47A248]">
                                    <title>MongoDB</title>
                                    <path d="M17.193 9.555c-1.264-5.58-4.252-7.414-4.573-8.115-.28-.394-.53-.954-.735-1.44-.036.495-.055.685-.523 1.184-.723.566-4.438 3.682-4.74 10.02-.282 5.912 4.27 9.435 4.888 9.884l.07.05A73.49 73.49 0 0111.91 24h.481c.114-1.032.284-2.056.51-3.07.417-.296.604-.463.85-.693a11.342 11.342 0 003.639-8.464c.01-.814-.103-1.662-.197-2.218zm-5.336 8.195s0-8.291.275-8.29c.213 0 .49 10.695.49 10.695-.381-.045-.765-1.76-.765-2.405z" /></svg>
                                <div className="text-xs font-thin font-pixel"> MongoDB </div>
                            </div>

                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-blue-400">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#4169E1]">
                                    <title>POSTGRESS</title>
                                ...
                                <div className="text-xs font-thin font-pixel"> PostgreSQL</div>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-6">
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-sky-400">
                                ...
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#4479A1]">
                                    <title>MYSQL</title>
                            ...
                            <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-white space-y-[-30px]">
                                <div className="text-3xl flex-shrink">☁️</div>
                                <img
                                    src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/oracle/oracle-original.svg"
                                    alt="ORACLE_CLOUD"
                                    className="w-18 h-18 flex-shrink-0" // w-15/h-15 no existen en Tailwind; usa w-12 o w-16

                                />
                                <div className="text-xs font-thin font-pixel"> Oracle Cloud</div>
                            </div>
                        </div>
                        ...
                        {/*                         <div className="flex space-x-6">
                            ...
                            <div className="w-20 h-20 flex items-center justify-center rounded-lg shadow-sm shadow-blue-500">
                                <div className="text-6xl" >C</div>
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-blue-500">
                                    <title>C#</title>
            ...
            {/* Card 4 */}
            <div className="items-center bg-gray-900/80 border-4 border-violet-400 p-4 rounded-lg shadow-lg shadow-violet-500/40">
                <h2 className="text-violet-400 text-lg mb-4 font-tourney animate-pulse text-center">[ TOOLS & OTHERS ]</h2>
                <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row justify-center items-center md:space-x-6 space-y-6 md:space-y-0 text-gray-300">
                    ...
                    <div className="flex space-x-6">
                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-amber-600">
                            ...
                            <div className="text-xs font-thin font-pixel"> Git</div>
                        </div>

                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-blue-600">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#1572B6]">
                                <title>FIGMA</title>
                            ...
                            <div className="text-xs font-thin font-pixel"> Figma</div>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-6">
                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-green-400">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-green-500">
                            ...
                            <div className="text-xs font-thin font-pixel"> Selenium</div>
                        </div>

                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-orange-500">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#FF6C37]">
                                <title>POSTMAN</title>
                            ...
                            <div className="text-xs font-thin font-pixel"> Postman</div>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-6">
                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-amber-50">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-white ">
                                <title>GITHUB</title>
                            ...
                            <div className="text-xs font-thin font-pixel"> GitHub</div>
                        </div>

                        <div className="w-20 h-20 flex flex-col items-center justify-center rounded-lg shadow-sm shadow-yellow-400">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 fill-[#FCC624]">
                                <title>LINUX</title>
                            ...
                            <div className="text-xs font-thin font-pixel"> Linux</div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-0 right-4 font-tourney">
                <Link href="/Projects">
